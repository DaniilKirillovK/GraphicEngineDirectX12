#include "LightingUtilMoreLight.hlsl"
#include "Common.hlsl"
...
{
    InstanceData instance = instanceBuffer[pin.instanceID];
    ...
    directLight = float4(ComputePointLight(gLights[instance.lightID], mat, worldPos,
        normal, toEyeW) * gLights[instance.lightID].Color.xyz * float3(AO, AO, AO), 1.0f);
